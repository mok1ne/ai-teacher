...
**Хранилище:** задайте `UPSTASH_REDIS_REST_URL` и `UPSTASH_REDIS_REST_TOKEN` (Upstash Redis или Vercel KV). Без них используется временное хранилище в памяти (не сохраняется между запусками).
